<form action="/editCategory/<?= $category['categoryID']?>" method="post">
    <div class="container">
        ...
        <a href="/dashboard" class="btn btn-sm btn-secondary">Back</a>
            <div class="card bg-secondary py-3 px-5 my-2 mx-auto">
                ...
                <div class="form-floating mt-2">
                    <input type="text" name="categoryName" id="floatingCName" class="form-control" placeholder="Enter Category Name" autofocus value="<?= set_value('categoryName'), $category['categoryName']?>">
