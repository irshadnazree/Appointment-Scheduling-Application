<form action="/staffRegistration/<?=$company?>" method="post">
    <div class="container">
        <div class="row">
            ...
            <div class="card bg-secondary py-3 px-5 my-2 mx-auto">
                ...
                <div class="row">
                    <div class="mt-3 mb-3 text-center">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to add new staff?');">Add Staff</button>
                    </div>
                </div> 
            </div>
        </div>
